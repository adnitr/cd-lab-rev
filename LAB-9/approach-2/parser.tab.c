...
{
  "\"end of file\"", "error", "\"invalid token\"", "CHAR", "EOL", "OR",
  "AND", "$accept", "calclist", "exp", "factor", YY_NULLPTR
};
...
#line 1166 "parser.tab.c"
  ...
  case 5: /* exp: exp OR factor  */
#line 120 "parser.y"
                { printf("OR\n"); }
#line 1172 "parser.tab.c"
    break;

  case 6: /* exp: exp AND factor  */
#line 121 "parser.y"
                 { printf("AND\n"); }
